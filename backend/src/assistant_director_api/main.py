...
from assistant_director_api.routers import projects, scenes, scripts, sync, users

app = FastAPI(title="Assistant Director API", version="0.2.0")

_settings = get_settings()
_settings.blob_storage_path.mkdir(parents=True, exist_ok=True)
...
app.include_router(scripts.router, prefix="/v1")
